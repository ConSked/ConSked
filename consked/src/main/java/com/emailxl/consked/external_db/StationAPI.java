...
public class StationAPI {
    ...
    private static final String SERVER_URL = "http://dev1.consked.com/webservice/Station/";
    private static final String TAG = "StationAPI";
    private static final boolean LOG = false;

    public static String readStation(int id) {
